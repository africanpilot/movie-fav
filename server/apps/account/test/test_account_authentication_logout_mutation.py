...
# graphql query
begin_gql = """mutation{ accountAuthenticationLogout{"""
input_vars = ""
...
general = lib.gen.compose_decos([pytest.mark.account_authentication_logout_mutation, pytest.mark.account])
...
def test_account_authentication_logout_mutation_response(benchmark):
    # clear db tables and reset
    lib.gen.reset_database()
    redis_db = lib.gen.db.get_engine("redisdb_movie", "redis")
    redis_db.flushdb()
