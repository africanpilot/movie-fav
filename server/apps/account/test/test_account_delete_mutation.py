...
# graphql query
begin_gql = """mutation{ accountDelete{"""
input_vars = ""
...
general = lib.gen.compose_decos([pytest.mark.account_delete_mutation, pytest.mark.account])
...
def test_account_delete_mutation_response(benchmark):
    # clear db tables and reset
    lib.gen.reset_database()
    redis_db = lib.gen.db.get_engine("redisdb_movie", "redis")
    redis_db.flushdb()
