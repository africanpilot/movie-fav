...
QUERY_NAME = "movieModify"

# graphql query
begin_gql = """mutation{ movieModify( movieInput: {"""
input_vars = f"""
    movie_fav_info_id: "1"
    movie_fav_info_episode_current: "1"
    movie_fav_info_status: plan_to_watch
    movie_fav_info_rating_user: 9.6
"""
...
general = lib.gen.compose_decos([pytest.mark.movie_modify_mutation, pytest.mark.movie])
...
def test_movie_modify_mutation_response(benchmark):
    ...
    input_data = {
        ...
        "movie_fav_info_rating_user": random.randint(1, 10)
    }
    input_vars = f"""
        movie_fav_info_id: "1"
        movie_fav_info_episode_current: "1"
