...
class MoviePopularQuery:
    ...
    def movie_popular_query(self, info: object, pageInfo: dict) -> dict:
        ...
        if response and response["response"]["code"] == 200 and response["result"]:
            ...
            with lib.gen.db.get_engine("psqldb_movie").connect() as db:
                ...
                redis_db.set(f"""movie_popular_query:{token_decode["user_id"]}:{redis_filter_info}""", dumps(response), ex=86400) #ex is in secs 86400
