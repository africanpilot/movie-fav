...
def test_get_query_request(benchmark, link_request: GeneralRequest, gql_info: GraphQLResolveInfo):
	...
	assert response == [('response', 'success', 1), ('response', 'code', 1), ('response', 'message', 1), ('response', 'version', 1), ('pageInfo', 'page_info_count', 1), ('result', 'email', 1), ('account_contact', 'id', 2), ('account_contact', 'account_info_id', 2), ('account_contact', 'first_name', 2), ('account_address', 'id', 2), ('account_address', 'address', 2), ('account_address', 'city', 2), ('result', 'registration_status', 1)]
...
def test_convert_to_db_cols_with_attr(benchmark, link_request: GeneralRequest, gql_info: GraphQLResolveInfo):
	...
	info_1 = gql_info(context_value_1, request_context_1)
	query_context_1 = link_request.get_query_request(selections=info_1.field_nodes)
	get_cols_attr = link_request.convert_to_db_cols_with_attr(resultObject=AccountInfo, root_node="result", query_context=query_context_1)
	assert get_cols_attr == [AccountInfo.email, AccountInfo.registration_status]

	# run benchmark
	benchmark(link_request.convert_to_db_cols_with_attr, resultObject=AccountInfo, root_node="result", query_context=query_context_1)
