...
NEXT_PUBLIC_PAYMENT_STRIPE_SERVICE_PERCENTAGE = parse_float(
    os.getenv("NEXT_PUBLIC_PAYMENT_STRIPE_SERVICE_PERCENTAGE", 0.029)
)
NEXT_PUBLIC_PAYMENT_PROVIDER_SERVICE_PERCENTAGE = parse_float(
    os.getenv("NEXT_PUBLIC_PAYMENT_PROVIDER_SERVICE_PERCENTAGE", 0.010)
)
