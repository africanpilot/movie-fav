...
from ariadne import EnumType, load_schema_from_path
from ariadne.asgi import GraphQL
from ariadne.contrib.federation import FederatedObjectType, make_federated_schema
from fastapi import FastAPI
from graphql.error.graphql_error import GraphQLError
from link_controller.controller_api import (
    get_private_models,
    get_private_routes_to_load,
    get_public_models,
    get_public_routes_to_load,
)
...
class ControllerToApollo(ControllerToApolloArbitraryStaticTypeDef):
    ...
    def _load_enums(self):
        return [
            ...
            if isinstance(cls, type) and hasattr(cls, "is_gql") and cls.is_gql
        ]
    ...
    def get_fastapi(self):
        ...
        if get_public_routes_to_load():
            for route in get_public_routes_to_load():
                app.include_router(
                    MicroserviceDynamicLinkImport.fork(["../../../../links/link_api/rest/public/"], route).execute()
                )
