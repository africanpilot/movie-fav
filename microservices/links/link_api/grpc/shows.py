...
class ShowsGrpcClient:
    ...
    def get_shows_query(body: Optional[dict] = None):
        return ShowsGrpcClient.deserialize_response(ShowsGrpcClient.get("GetShowsQuery", body))

    @staticmethod
    def get_shows_season_query(body: Optional[dict] = None):
        return ShowsGrpcClient.deserialize_response(ShowsGrpcClient.get("GetShowsSeasonQuery", body))

    @staticmethod
    def get_shows_episode_query(body: Optional[dict] = None):
        return ShowsGrpcClient.deserialize_response(ShowsGrpcClient.get("GetShowsEpisodeQuery", body))

    @staticmethod
    def get_all_shows_season_query(body: Optional[dict] = None):
        return ShowsGrpcClient.deserialize_response(ShowsGrpcClient.get("GetAllShowsSeasonQuery", body))

    @staticmethod
    def get_current_episode_query(body: Optional[dict] = None):
        return ShowsGrpcClient.deserialize_response(ShowsGrpcClient.get("GetCurrentEpisodeQuery", body))

    @staticmethod
    def get_remaining_shows_cast_query(body: Optional[dict] = None):
        return ShowsGrpcClient.deserialize_response(ShowsGrpcClient.get("GetRemainingShowsCastQuery", body))
