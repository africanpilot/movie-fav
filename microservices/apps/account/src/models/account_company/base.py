...
class AccountCompanyBase(SQLModel):
  ...
  dba: Optional[str] = Field(max_length=255)
  ...
  product_description: Optional[str] = Field(max_length=255)
  ...
  sole_first_name: Optional[str] = Field(max_length=255)
  sole_last_name: Optional[str] = Field(max_length=255)
