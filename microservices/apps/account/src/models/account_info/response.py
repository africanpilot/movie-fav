...
from account.src.models.account_company.base import AccountCompany, AccountCompanyBase
from link_lib.microservice_request import LinkRequest
from link_models.base import BaseResponse, ConstBase, PageInfoInput
from account.src.models.account_info.base import AccountInfo, AccountInfoBase, AccountInfoFilterInput, AccountInfoPageInfoInput
...
class AccountInfoResponses(LinkRequest):
    ...
    def account_info_response(
        ...
        account_info = self.convert_to_db_cols_with_attr(resultObject=AccountInfo, info=info, query_context=query_context, root_node=baseRootNode)
        ...
        return self.success_response(result=result, pageInfo=page_info, nullPass=nullPass, resultObject=AccountInfoResponse)
    ...
    def account_authentication_response(
        ...
        return self.success_response(result=auth_result, pageInfo=response.pageInfo, resultObject=AccountAuthenticationResponse)
