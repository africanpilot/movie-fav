...
class AccountCompanyQuery(GraphQLModel, AccountLib, AccountCompanyResponses):
    ...
    def load_defs(self):
        ...
        def resolve_account_company(
            ...
            redis_filter_info = json.dumps({"account_company_id": token_decode.account_company_id, **pageInfo, **filterInput, **dict(query_context=query_context)}, cls=GeneralJSONEncoder)
