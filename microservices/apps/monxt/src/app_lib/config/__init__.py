...
if importlib.util.find_spec("." + APP_DEFAULT_ENV, package="monxt.src.app_lib.config"):
    service_module = importlib.import_module("." + APP_DEFAULT_ENV, package="monxt.src.app_lib.config")
