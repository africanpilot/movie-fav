...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("id", sa.INTEGER, primary_key=True),
        sa.Column(
            "shows_info_id", sa.INTEGER, sa.ForeignKey("shows.shows_info.id", ondelete="CASCADE"), nullable=False
        ),
        sa.Column("imdb_id", sa.VARCHAR(100), nullable=False, unique=True),
    ...
    op.create_table(
        ...
        sa.Column(
            "shows_season_id", sa.INTEGER, sa.ForeignKey("shows.shows_season.id", ondelete="CASCADE"), nullable=False
        ),
        sa.Column("imdb_id", sa.VARCHAR(100), nullable=False, unique=True),
        sa.Column(
            "shows_imdb_id",
            sa.VARCHAR(100),
            sa.ForeignKey("shows.shows_info.imdb_id", ondelete="CASCADE"),
            nullable=False,
        ),
        sa.Column("title", sa.VARCHAR(), nullable=True),
        sa.Column("year", sa.INTEGER, nullable=True),
