...
from shows.src.models.shows_info import ShowsInfo, ShowsInfoBase, ShowsInfoFilterInput, ShowsInfoPageInfoInput
...
class ShowsInfoResponses(LinkRequest):
    ...
    def shows_info_cols(
        ...
        return self.convert_to_db_cols_with_attr(
            resultObject=ShowsInfo, info=info, query_context=query_context, root_node=root_node
        )

    def shows_season_cols(
        self, info: GraphQLResolveInfo = None, query_context=None, root_node: str = "shows_season"
    ) -> list[ShowsSeason]:
        return self.convert_to_db_cols_with_attr(
            resultObject=ShowsSeason, info=info, query_context=query_context, root_node=root_node
        )

    def shows_episode_cols(
        self, info: GraphQLResolveInfo = None, query_context=None, root_node: str = "shows_episode"
    ) -> list[ShowsEpisode]:
        return self.convert_to_db_cols_with_attr(
            resultObject=ShowsEpisode, info=info, query_context=query_context, root_node=root_node
        )

    def shows_response_array(
        self,
        showsInfo: Optional[list[ShowsInfo]] = None,
        showSeason: Optional[list[ShowsSeason]] = None,
        showEpisode: Optional[list[ShowsEpisode]] = None,
    ):
        ...
        return select(*showsInfo, shows_season, func.count().over().label("page_info_count"))
