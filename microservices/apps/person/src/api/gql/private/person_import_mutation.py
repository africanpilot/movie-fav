...
from person.src.models.person_info import PersonInfoCreateInput, PersonInfo, PersonInfoResponse
    ...
    def load_defs(self):
        ...
        def resolve_person_import(_, info: GraphQLResolveInfo, pageInfo: PageInfoInput = None) -> PersonInfoResponse:
            ...
            with self.get_session("psqldb_person") as db:
              all_saga_state_to_import = self.person_saga_state_read.get_remaining_person_sagas_to_ingest(db, pageInfo.first)
