...
from person.src.models.person_info.base import (
    PersonInfo,
    PersonInfoBase,
...
from person.src.models.person_info.response import PersonInfoBaseResponse, PersonInfoResponse, PersonInfoResponses
