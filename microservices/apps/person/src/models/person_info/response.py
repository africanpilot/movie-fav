...
from person.src.models.person_info import PersonInfo, PersonInfoBase, PersonInfoPageInfoInput, PersonInfoFilterInput
...
class PersonInfoResponses(LinkRequest):
  ...
  def person_info_cols(self, info: GraphQLResolveInfo = None, query_context = None, root_node: str = 'result') -> list[PersonInfo]:
    return self.convert_to_db_cols_with_attr(resultObject=PersonInfo, info=info, query_context=query_context, root_node=root_node)
