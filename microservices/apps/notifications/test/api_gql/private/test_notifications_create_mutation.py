...
from link_models.enums import NotifyStatusEnum, NotifyTemplateEnum
...
GENERAL_PYTEST_MARK = LinkGeneral().compose_decos(
    [pytest.mark.notifications_create_mutation, pytest.mark.notifications]
)


@GENERAL_PYTEST_MARK
@pytest.mark.notifications_bench
def test_notifications_create_mutation(
