...
from notifications.src.app_lib.config import APP_DEFAULT_EMAIL, APP_DEFAULT_ENV, APP_SENDGRID_API_KEY
...
class SendgridHelper(LinkResponse):
    ...
    def base_message(self):
        self.message = Mail(from_email=self.from_email, to_emails=self.send_to_email)
