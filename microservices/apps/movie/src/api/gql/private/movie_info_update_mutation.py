...
from movie.src.models.movie_info import MovieInfoPageInfoInput, MovieInfoResponse, MovieInfoUpdateFilterInput
from movie.src.models.movie_saga_state import MovieSagaStateCreateInput, MovieSagaStateUpdate
...
class MovieInfoUpdateMutation(GraphQLModel, MovieLib):
    ...
    def load_defs(self):
        ...
        def resolve_movie_info_update(
            ...
            updateFilterInput: MovieInfoUpdateFilterInput,
            ...
            with self.get_session("psqldb_movie") as db:
                all_saga = self.movie_saga_state_create.movie_saga_state_create(
                    db, [MovieSagaStateCreateInput(movie_info_imdb_id=imdb) for imdb in updateFilterInput.imdb_ids]
                )
