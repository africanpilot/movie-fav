...
from movie.src.models.movie_info.base import MovieInfo,MovieInfoBase, MovieInfoPageInfoInput, MovieInfoFilterInput
...
class MovieInfoResponse(BaseResponse):
  result: list[MovieInfoBaseResponse] = None
...
class MovieInfoResponses(LinkRequest):
  ...
  def movie_info_cols(self, info: GraphQLResolveInfo = None, query_context = None, root_node: str = 'result') -> list:
    return self.convert_to_db_cols_with_attr(resultObject=MovieInfo, info=info, query_context=query_context, root_node=root_node)
