...
def test_movie_info_update_mutation(benchmark, test_database: Session, flush_redis_db, create_account, private_schema, create_movie_info):
  flush_redis_db()
  ...
  assert movie_1.payload["release_date"] == None
